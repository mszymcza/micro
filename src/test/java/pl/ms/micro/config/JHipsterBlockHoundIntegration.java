...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("pl.ms.micro.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("pl.ms.micro.security.DomainUserDetailsService", "createSpringSecurityUser");
